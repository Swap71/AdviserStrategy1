...
{
    class PP_PersonalInsuranceCover_Qs
    {
        ...
        [Test]
        public void PP_Personal_InsuranceCover_Qs_Validate()
        {
            var expectedResultICQ1 = System.Configuration.ConfigurationManager.AppSettings["expectedResultICQ1"];
            var expectedResultICQ2 = System.Configuration.ConfigurationManager.AppSettings["expectedResultICQ2"];
            var expectedResultICQ3 = System.Configuration.ConfigurationManager.AppSettings["expectedResultICQ3"];

            var expectedResultICD1 = System.Configuration.ConfigurationManager.AppSettings["expectedResultICD1"];
            var expectedResultICD2 = System.Configuration.ConfigurationManager.AppSettings["expectedResultICD2"];
            var expectedResultICD3 = System.Configuration.ConfigurationManager.AppSettings["expectedResultICD3"];


            var expectedResultICD4 = System.Configuration.ConfigurationManager.AppSettings["expectedResultICD4"];
            var expectedResultICD5 = System.Configuration.ConfigurationManager.AppSettings["expectedResultICD5"];
            var expectedResultICD6 = System.Configuration.ConfigurationManager.AppSettings["expectedResultICD6"];

            var expectedResultICD7 = System.Configuration.ConfigurationManager.AppSettings["expectedResultICD7"];
            var expectedResultICD8 = System.Configuration.ConfigurationManager.AppSettings["expectedResultICD8"];
            var expectedResultICD9 = System.Configuration.ConfigurationManager.AppSettings["expectedResultICD9"];




            var expectedResultICD10 = System.Configuration.ConfigurationManager.AppSettings["expectedResultICD10"];
            var expectedResultICD11 = System.Configuration.ConfigurationManager.AppSettings["expectedResultICD11"];
            var expectedResultICD12 = System.Configuration.ConfigurationManager.AppSettings["expectedResultICD12"];

            var expectedResultICD13 = System.Configuration.ConfigurationManager.AppSettings["expectedResultICD13"];
            var expectedResultICD14 = System.Configuration.ConfigurationManager.AppSettings["expectedResultICD14"];
            var expectedResultICD15 = System.Configuration.ConfigurationManager.AppSettings["expectedResultICD15"];
            // Thread.Sleep(2000);
            // Thread.Sleep(2000);
            Thread.Sleep(2000);
        ...
        /*****    Assert.IsTrue(expectedResult3.Equals(As3));**********/
            ...
            ************************/
            ...
            driver.SwitchTo().Frame(1);
            String IC1 = driver.FindElement(By.CssSelector("body")).Text;
            //   driver.FindElement(By.CssSelector("body")).Clear();
            ...
            Assert.AreEqual(expectedResultICD1, IC1);
            //   Console.WriteLine("Frame 4");

            driver.SwitchTo().DefaultContent();

            driver.SwitchTo().Frame(2);
            String IC2 = driver.FindElement(By.CssSelector("body")).Text;
            Console.WriteLine("Frame 2");
            Assert.AreEqual(expectedResultICD2, IC2);

            driver.SwitchTo().DefaultContent();

            driver.SwitchTo().Frame(3);
            String IC3 = driver.FindElement(By.CssSelector("body")).Text;
            Console.WriteLine("Frame 3");
            Assert.AreEqual(expectedResultICD3, IC3);

            driver.SwitchTo().DefaultContent();


            // String IC1 = driver.FindElement(By.XPath("")).Text;
            //*[@id="ctl00_ctl00_cph1_cph1_InsuranceCover_ctl02_soa_control"]/div/div/div[2]/div[2]/div[2]/div/table/tbody/tr[1]/td[2]/span
            ...
            driver.SwitchTo().Frame(1);
            String IP10 = driver.FindElement(By.CssSelector("body")).Text;
            Console.WriteLine("Frame 1");
            Assert.AreEqual(expectedResultICD10, IP10);

            driver.SwitchTo().DefaultContent();

            driver.SwitchTo().Frame(2);
            String IP20 = driver.FindElement(By.CssSelector("body")).Text;
            Console.WriteLine("Frame 2");
            Assert.AreEqual(expectedResultICD11, IP20);

            driver.SwitchTo().DefaultContent();

            driver.SwitchTo().Frame(3);
            String IP30 = driver.FindElement(By.CssSelector("body")).Text;
            Console.WriteLine("Frame 3");
            Assert.AreEqual(expectedResultICD12, IP30);
           ...
           // Thread.Sleep(1000);
            ...
            driver.SwitchTo().Frame(1);
            String IP11 = driver.FindElement(By.CssSelector("body")).Text;
            Console.WriteLine("Frame 1");
            Assert.AreEqual(expectedResultICD13, IP11);

            driver.SwitchTo().DefaultContent();

            driver.SwitchTo().Frame(2);
            String IP21 = driver.FindElement(By.CssSelector("body")).Text;
            Console.WriteLine("Frame 2");
            Assert.AreEqual(expectedResultICD14, IP21);

            driver.SwitchTo().DefaultContent();

            driver.SwitchTo().Frame(3);
            String IP31 = driver.FindElement(By.CssSelector("body")).Text;
            Console.WriteLine("Frame 3");
            Assert.AreEqual(expectedResultICD12, IP31);
...
/*
            ...
            driver.SwitchTo().Frame(1);
            String TP1 = driver.FindElement(By.CssSelector("body")).Text;
            Console.WriteLine("Frame 1");
            Assert.AreEqual(expectedResultICD4, TP1);

            driver.SwitchTo().DefaultContent();

            driver.SwitchTo().Frame(2);
            String TP2 = driver.FindElement(By.CssSelector("body")).Text;
            Console.WriteLine("Frame 2");
            Assert.AreEqual(expectedResultICD5, TP2);

            driver.SwitchTo().DefaultContent();

            driver.SwitchTo().Frame(3);
            String TP3 = driver.FindElement(By.CssSelector("body")).Text;
            Console.WriteLine("Frame 3");
            Assert.AreEqual(expectedResultICD6, TP3);
         ...
         /*   String expectedResult13 = "Yes";
            ...
            driver.SwitchTo().Frame(1);
            String IP1 = driver.FindElement(By.CssSelector("body")).Text;
            Console.WriteLine("Frame 1");
            Assert.AreEqual(expectedResultICD7, IP1);

            driver.SwitchTo().DefaultContent();

            driver.SwitchTo().Frame(2);
            String IP2 = driver.FindElement(By.CssSelector("body")).Text;
            Console.WriteLine("Frame 2");
            Assert.AreEqual(expectedResultICD8, IP2);

            driver.SwitchTo().DefaultContent();

            driver.SwitchTo().Frame(3);
            String IP3 = driver.FindElement(By.CssSelector("body")).Text;
            Console.WriteLine("Frame 3");
            Assert.AreEqual(expectedResultICD9, IP3);

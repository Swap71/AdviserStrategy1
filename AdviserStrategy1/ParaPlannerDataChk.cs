...
namespace AdviserStrategy1
{
    class PPCashFlowChk
    {
        ...
        [Test]
        public void PP_CashFlow_Validate()
        {
            var expectedResultCFD1 = System.Configuration.ConfigurationManager.AppSettings["expectedResultCFD1"];
            var expectedResultCFD2 = System.Configuration.ConfigurationManager.AppSettings["expectedResultCFD2"];
            var expectedResultCFD3 = System.Configuration.ConfigurationManager.AppSettings["expectedResultCFD3"];

...
{
    class EstatePlanningDataValidate
    {
        ...
        [Test]
        public void PP_EstatePlanning_DataValidate()
        {


            var expectedResultEP1 = System.Configuration.ConfigurationManager.AppSettings["expectedResultEP1"];
            var expectedResultEP2 = System.Configuration.ConfigurationManager.AppSettings["expectedResultEP2"];
            var expectedResultEP3 = System.Configuration.ConfigurationManager.AppSettings["expectedResultEP3"];
       ...
       //     Assert.IsTrue(expectedResult3.Equals(As3));
        ...
        //    Thread.Sleep(1000);
            ...
            String EP51 = driver.FindElement(By.CssSelector("body")).Text;
            Console.WriteLine("Frame 2");
            Assert.AreEqual(expectedResultEP2, EP51);

            driver.SwitchTo().DefaultContent();

            driver.SwitchTo().Frame(3);
            String EP61 = driver.FindElement(By.CssSelector("body")).Text;
            Console.WriteLine("Frame 3");
            Assert.AreEqual(expectedResultEP3, EP61);
 ...
 /******           IList<IWebElement> iframes8 = driver.FindElements(By.TagName("iframe"));
           ...
           driver.SwitchTo().Frame(1);
            ...
            IWebElement ResEP = driver.FindElement(By.CssSelector("body"));
            String AsEP1 = driver.FindElement(By.CssSelector("body")).Text;

            Console.WriteLine("ASEP1 is :" + AsEP1);


           

            //  String expectedResult1 = "Stategy Test on 28 Feb 2018";
            Assert.AreEqual(expectedResultEP1.Contains(AsEP1), "Actual Data -" + AsEP1 + " found instead of Expected Data -" + expectedResultEP1);
            driver.SwitchTo().DefaultContent();

            driver.SwitchTo().Frame(2);

            String AsEP2 = driver.FindElement(By.CssSelector("body")).Text;

            Console.WriteLine("ASEP2 is :" + AsEP2);




            //  String expectedResult1 = "Stategy Test on 28 Feb 2018";
            Assert.AreEqual(expectedResultEP2.Contains(AsEP2), "Actual Data -" + AsEP2 + " found instead of Expected Data -" + expectedResultEP2);
            driver.SwitchTo().DefaultContent();

            driver.SwitchTo().Frame(3);

            String AsEP3 = driver.FindElement(By.CssSelector("body")).Text;

            Console.WriteLine("ASEP3 is :" + AsEP3);




            //  String expectedResult1 = "Stategy Test on 28 Feb 2018";
            Assert.AreEqual(expectedResultEP3.Contains(AsEP3), "Actual Data -" + AsEP3 + " found instead of Expected Data -" + expectedResultEP3);
            driver.SwitchTo().DefaultContent();********/
            //   Thread.Sleep(1000);
            driver.SwitchTo().Frame(4);

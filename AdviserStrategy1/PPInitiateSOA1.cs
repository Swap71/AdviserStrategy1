...
namespace AdviserStrategy1
{
    class PPInitiateSOA1
    {
        ...
        [Test]
        public void ParaPlannerInitiateSOA1()
        {
            ...
            body4.SendKeys("Advise Statement in Financial Position under Cash Flow on 5 March 2018 ");
            ...
            ************************/
            ...
            // body3.SendKeys("TESTING...Frames");
            body580.SendKeys("Advise Statement for Life Cover 5 March 2018");
            ...
            // body3.SendKeys("TESTING...Frames");
            body65.SendKeys("Advise Statement for Personal Risk Cover 05 March 2018 ");
            ...
            // body3.SendKeys("TESTING...Frames");
            body100.SendKeys("Advise Statement for Trauma / Critical Illness Cover 5*March 2018 ");
            ...
            // body3.SendKeys("TESTING...Frames");
            body196.SendKeys("Advise Statement for Income Protection Cover on 5 March 2018");
            ...
            // body3.SendKeys("TESTING...Frames");
            body704.SendKeys("Test for Super 5 March 2018");
            driver.SwitchTo().DefaultContent();
            Thread.Sleep(3000);
 ...
 /****OK           driver.FindElement(By.XPath("//*[@id='ctl00_ctl00_cph1_cph1_EstatePlanningControl_ctl00_soa_control']/div/div/div[2]/div[3]/div/ul/li[3]/div/label/span")).Click();****/
            //*[@id="ctl00_ctl00_cph1_cph1_InsuranceCover_dlInsuranceType_ctl00_ctl00_soa_control"]/div/div/div[2]/div[4]/div
  ...
  /***ok          if (!(GRAPH8.Contains("Included graph in SOA.")))
            {
            ...
            ****/
            ...
            Console.WriteLine("Frame 4");
            // body3.SendKeys("TESTING...Frames");
            body48.SendKeys("Advise Statement in EP 5 MARCH 2018 ");
            ...
            *****************/
            ...
            //*[@id="ctl00_ctl00_cph1_cph1_SOAControl_BpoStatementReview"]/div/div/div/div/ul/li[6]/div/ul/li/div/div/div[2]/div[5]/a[1]

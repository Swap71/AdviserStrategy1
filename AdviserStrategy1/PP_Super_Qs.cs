...
namespace AdviserStrategy1
{
    class PP_Super_Qs
    {
      ...
      //  public object IJavascriptExecutor { get; private set; }
        ...
        [Test]
        public void PP_Super_Qs_Validate()
        {
            var expectedResultSQ1 = System.Configuration.ConfigurationManager.AppSettings["expectedResultSQ1"];
            var expectedResultSQ2 = System.Configuration.ConfigurationManager.AppSettings["expectedResultSQ2"];
            var expectedResultSQ3 = System.Configuration.ConfigurationManager.AppSettings["expectedResultSQ3"];
            var expectedResultSQ4 = System.Configuration.ConfigurationManager.AppSettings["expectedResultSQ4"];

            var expectedResultSQ5 = System.Configuration.ConfigurationManager.AppSettings["expectedResultSQ5"];
            var expectedResultSQ6 = System.Configuration.ConfigurationManager.AppSettings["expectedResultSQ6"];
            var expectedResultSQ7 = System.Configuration.ConfigurationManager.AppSettings["expectedResultSQ7"];
            var expectedResultSQ8 = System.Configuration.ConfigurationManager.AppSettings["expectedResultSQ8"];
            var expectedResultSQ9 = System.Configuration.ConfigurationManager.AppSettings["expectedResultSQ9"];
        ...
        //    Console.WriteLine(expectedResultICQ3);
         ...
         //   Assert.AreEqual(expectedResultICQ3, As15);
          ...
          //  Assert.AreEqual(expectedResultSQ1.Contains(AsS1), "Actual Data -" + AsS1 + " found instead of Expected Data -" + expectedResultSQ1);
            ...
            String AsS8 = driver.FindElement(By.XPath("//*[@id='soa_control']/div/div/div[2]/div[2]/div[3]/table/tbody/tr[5]/td[2]/span")).Text;

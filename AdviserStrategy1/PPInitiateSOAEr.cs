...
namespace AdviserStrategy1
{
    class PPInitiateSOAEr
    {
        ...
        [Test]
        public void ParaPlannerInitiateSOAError()
        {
            Thread.Sleep(2000);
            ...
            for (int i = 1; i <= 50; i++)
            {
                ...
                if (ss19 != null)
                {
                    ...
                    var img = driver.FindElement(By.XPath(".//*[@id='btnCreatSOA']"));
                    img.Click();
            ...
            *****************/
            ...
            //   wait.Until(ExpectedConditions.ElementIsVisible(By.XPath(".//*[@id='ctl00_ctl00_cph1_cph1_SOAControl_rgSOA_ctl00__2']/td[4]")));
            ...
            String message1 = driver.FindElement(By.XPath(".//*[@id='ctl00_ctl00_cph1_cph1_SOAControl_pnlFinalizeSOA']/div/div/div/div/div[2]/span/span")).Text;
            Console.WriteLine("Success message of Finalise SOA DOC is :" + message1);
            Thread.Sleep(3000);

            // Thread.Sleep(5000);

            // Assert.IsTrue(message1.Contains("SOA Finalised."), message1 + " doesn't contains 'message.'");


            /*       Assert.IsTrue(message1.Contains("Finalising SOA..."), message1 + " doesn't contains 'message.'");*/
            ...
            Assert.IsTrue(message1.Contains("Please"), message1 + " doesn't contains 'message.'");
            //       Please select at - least one SOA document to Finalise.
            // Assert.IsTrue(message1.Contains("SOA document created successfully."), message1 + " doesn't contains 'message.'");
            ...
            /******
                        Thread.Sleep(7000);
                        String message1 = driver.FindElement(By.XPath(".//*[@id='ctl00_ctl00_cph1_cph1_SOAControl_pnlFinalizeSOA']/div/div/div/div/div[2]/div")).Text;
                        Console.WriteLine("Finalise Success message is ->>:" + message1);
                        Assert.IsTrue(message1.Contains("SOA Finalised."), message1 + " doesn't contains 'message1.'");
                        //  string title = driver.Title;
